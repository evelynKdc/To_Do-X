...
export function ItemContainer(props) {
   ...
   const Trash = ()=>{
      return(
        <button onClick={handlerTrash} className="buttons danger_button button_trash"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-trash3" viewBox="0 0 16 16">
